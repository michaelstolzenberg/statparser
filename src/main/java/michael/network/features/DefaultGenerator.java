...
public class DefaultGenerator implements FeatureGenerator {
    ...
    public DefaultGenerator() {
        ...
        //set.add(new AddressedValueFeatureGenerator(BUFFER0_TOKEN));
        //set.add(new AddressedValueFeatureGenerator(BUFFER1_TOKEN));
        ...
        set.add(new AddressedValueFeatureGenerator(RDEPSTACK1_DEP));
